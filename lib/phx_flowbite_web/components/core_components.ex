defmodule PhxFlowbiteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PhxFlowbiteWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PhxFlowbiteWeb.Gettext, "errors", msg, opts)
    # end
